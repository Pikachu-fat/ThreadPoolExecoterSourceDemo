...
public class TaskExecuter {
    ...
    private synchronized static void ensureThreadPoolExecutor() {
        if (sExecutorService == null) {
            sExecutorService = new ThreadPoolExecutor(5, MAX_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS,
                    limitedQueue, new DefaultThreadPoolFactory(), new ThreadPoolExecutor.DiscardOldestPolicy());
        }
    }
